...
export const AccountingAbi = [
  ...
  {
    constant: true,
    inputs: [{ name: 'gav', type: 'uint256' }, { name: 'unclaimedFeesInDenominationAsset', type: 'uint256' }],
    name: 'calcNav',
  ...
  {
    constant: false,
    inputs: [{ name: '_numShares', type: 'uint256' }, { name: '_altAsset', type: 'address' }],
  ...
  {
    constant: true,
    inputs: [{ name: 'totalValue', type: 'uint256' }, { name: 'numShares', type: 'uint256' }],
    name: 'valuePerShare',
    outputs: [{ name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
