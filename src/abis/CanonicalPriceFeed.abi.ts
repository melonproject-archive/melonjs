...
export const CanonicalPriceFeedAbi = [
  {
    constant: true,
    inputs: [{ name: 'ofExchange', type: 'address' }, { name: 'querySignature', type: 'bytes4' }],
  ...
  {
    constant: false,
    inputs: [{ name: 'ofAsset', type: 'address' }, { name: 'assetIndex', type: 'uint256' }],
    name: 'removeAsset',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ name: 'ofAssets', type: 'address[]' }, { name: 'newPrices', type: 'uint256[]' }],
    name: 'update',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ name: 'ofAsset', type: 'address' }, { name: 'querySignature', type: 'bytes4' }],
  ...
  },
  {
    ...
    inputs: [{ name: 'ofAsset', type: 'address' }],
    name: 'getPriceInfo',
    outputs: [{ name: 'price', type: 'uint256' }, { name: 'assetDecimals', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [{ name: 'invertedPrice', type: 'uint256' }, { name: 'assetDecimals', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    constant: true,
    inputs: [{ name: 'ofBase', type: 'address' }, { name: 'ofQuote', type: 'address' }],
    name: 'getReferencePriceInfo',
    outputs: [{ name: 'referencePrice', type: 'uint256' }, { name: 'decimal', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    constant: false,
    inputs: [{ name: 'ofExchange', type: 'address' }, { name: 'exchangeIndex', type: 'uint256' }],
    name: 'removeExchange',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: true,
    inputs: [{ name: 'sellAsset', type: 'address' }, { name: 'buyAsset', type: 'address' }],
