...
export const HubAbi = [
  ...
  {
    constant: false,
    inputs: [{ name: 'src', type: 'address' }, { name: 'dst', type: 'address' }, { name: 'sig', type: 'bytes32' }],
    name: 'forbid',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ name: 'src', type: 'bytes32' }, { name: 'dst', type: 'bytes32' }, { name: 'sig', type: 'bytes32' }],
    name: 'forbid',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: true,
    inputs: [{ name: 'src_', type: 'address' }, { name: 'dst_', type: 'address' }, { name: 'sig', type: 'bytes4' }],
    name: 'canCall',
    outputs: [{ name: '', type: 'bool' }],
    payable: false,
    stateMutability: 'view',
  ...
  {
    inputs: [{ name: '_manager', type: 'address' }, { name: '_name', type: 'string' }],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
