...
export const TradingAbi = [
  ...
  {
    constant: true,
    inputs: [{ name: 'exchange', type: 'address' }, { name: 'asset', type: 'address' }],
    name: 'isOrderExpired',
    outputs: [{ name: '', type: 'bool' }],
    payable: false,
    stateMutability: 'view',
  ...
  {
    constant: true,
    inputs: [{ name: 'ofExchange', type: 'address' }, { name: 'ofAsset', type: 'address' }],
  ...
  },
  {
    ...
    outputs: [{ name: '', type: 'address[]' }, { name: '', type: 'address[]' }, { name: '', type: 'bool[]' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    constant: false,
    inputs: [{ name: 'exchange', type: 'address' }, { name: 'sellAsset', type: 'address' }],
