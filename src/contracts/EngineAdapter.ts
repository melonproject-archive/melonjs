...
export class EngineAdapter extends Contract {
  constructor(addressOrName: string, providerOrSigner: ethers.Signer | ethers.providers.Provider) {
    super(new.target.abi, addressOrName, providerOrSigner);
  }

  /**
   * `EngineAdapter` contract call for the `getOrder` function.
   *
  ...
  /**
   * `EngineAdapter` contract transaction for `cancelOrder` function.
   *
   * @contract EngineAdapter
  ...
  /**
   * `EngineAdapter` contract transaction for `makeOrder` function.
   *
   * @contract EngineAdapter
  ...
  /**
   * `EngineAdapter` contract transaction for `takeOrder` function.
   *
   * @contract EngineAdapter
