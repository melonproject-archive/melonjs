...
export class EthfinexAdapter extends Contract {
  constructor(addressOrName: string, providerOrSigner: ethers.Signer | ethers.providers.Provider) {
    super(new.target.abi, addressOrName, providerOrSigner);
  }

  /**
   * `EthfinexAdapter` contract call for the `getOrder` function.
   *
   * @contract EthfinexAdapter
  ...
  /**
   * `EthfinexAdapter` contract transaction for `cancelOrder` function.
   *
   * @contract EthfinexAdapter
  ...
  /**
   * `EthfinexAdapter` contract transaction for `makeOrder` function.
   *
   * @contract EthfinexAdapter
  ...
  /**
   * `EthfinexAdapter` contract transaction for `takeOrder` function.
   *
   * @contract EthfinexAdapter
  ...
  /**
   * `EthfinexAdapter` contract transaction for `withdrawTokens` function.
   *
   * @contract EthfinexAdapter
   * @signature function withdrawTokens(address,address[8],uint256[8],bytes[4],bytes32,bytes)
   */
  withdrawTokens: (
    _targetExchange: string,
    _orderAddresses: [string, string, string, string, string, string, string, string],
