 ...
 *
 * Adapter between Melon and Uniswap
 *
 * @author Melonport AG <team@melonport.com>
 */
export class UniswapAdapter extends Contract {
  public readonly ethers: UniswapAdapterEthersContract;
...
export interface UniswapAdapterEthersContract extends ethers.Contract {
