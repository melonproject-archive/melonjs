...
export class ZeroExV2ERC20Proxy extends Contract {
  public readonly ethers: ZeroExV2ERC20ProxyEthersContract;
  ...
  /**
   * `ZeroExV2ERC20Proxy` contract call for the `authorities` function.
   *
   * @contract ZeroExV2ERC20Proxy
  ...
  /**
   * `ZeroExV2ERC20Proxy` contract call for the `owner` function.
   *
   * @contract ZeroExV2ERC20Proxy
   * @signature owner()
  ...
  /**
   * `ZeroExV2ERC20Proxy` contract call for the `getProxyId` function.
   *
   * @contract ZeroExV2ERC20Proxy
  ...
  /**
   * `ZeroExV2ERC20Proxy` contract call for the `authorized` function.
   *
   * @contract ZeroExV2ERC20Proxy
  ...
  /**
   * `ZeroExV2ERC20Proxy` contract call for the `getAuthorizedAddresses` function.
   *
   * @contract ZeroExV2ERC20Proxy
  ...
  /**
   * `ZeroExV2ERC20Proxy` contract transaction for `addAuthorizedAddress` function.
   *
   * @contract ZeroExV2ERC20Proxy
  ...
  /**
   * `ZeroExV2ERC20Proxy` contract transaction for `removeAuthorizedAddress` function.
   *
   * @contract ZeroExV2ERC20Proxy
  ...
  /**
   * `ZeroExV2ERC20Proxy` contract transaction for `removeAuthorizedAddressAtIndex` function.
   *
   * @contract ZeroExV2ERC20Proxy
  ...
  /**
   * `ZeroExV2ERC20Proxy` contract transaction for `transferOwnership` function.
   *
   * @contract ZeroExV2ERC20Proxy
...
export interface ZeroExV2ERC20ProxyEthersContract extends ethers.Contract {
