...
export interface UniswapTakeOrderArgs {
  makerAsset: Address;
  takerAsset: Address;
...
export class UniswapTradingAdapter extends BaseTradingAdapter {
  /**
   ...
   */
  public takeOrder(from: Address, args: UniswapTakeOrderArgs) {
